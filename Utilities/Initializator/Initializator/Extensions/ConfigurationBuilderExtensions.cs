...
namespace Initializator.Extensions;

public static class ConfigurationBuilderExtensions
{
    public static TConfiguration GetConfiguration<TConfiguration>(
        this IConfigurationRoot configurationManager,
        string sectionName)
    ...
    public static TConfiguration GetConfiguration<TConfiguration>(this IConfigurationRoot configurationManager)
        where TConfiguration : new()
    {
        return configurationManager.GetConfiguration<TConfiguration>(typeof(TConfiguration).Name);
    }

    public static TConfiguration GetSecret<TConfiguration>(this IConfigurationRoot configuration)
        where TConfiguration : new()
    {
    ...
    public static T GetRequiredEnvironmentVariable<T>(this IConfigurationRoot configuration, string variableName)
    {
