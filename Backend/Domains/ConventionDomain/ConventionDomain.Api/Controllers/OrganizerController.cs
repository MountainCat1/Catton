...
public class OrganizerController : Controller
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create(OrganizerCreateDto createDto)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update([FromRoute] Guid id, [FromBody] OrganizerUpdateDto updateDto)
    {
