...
public static class AuthorizationPoliciesDefiner
{
    ...
    private static void DefineAuthorizationPolicies(AuthorizationOptions options)
    {
        ...
        options.AddPolicyWithRequirements(Policies.ReadOneConvention, new IAuthorizationRequirement[]
        {
        ...
        options.AddPolicyWithRequirements(Policies.RemoveAttendee, new IAuthorizationRequirement[]
        {
            new IsOrganizerOfRequirement()
        });
        options.AddPolicyWithRequirements(Policies.UpdateTicket, new IAuthorizationRequirement[]
        {
            new IsOrganizerOfRequirement()
        });
        ...
        options.AddPolicyWithRequirements(Policies.ReadOwnTickets, new IAuthorizationRequirement[]
        {
            new IsAtendeeOfRequirement()
        });
        options.AddPolicyWithRequirements(Policies.ReadTickets, new IAuthorizationRequirement[]
        {
            new IsOrganizerOfRequirement()
        });
