...
{
    public class SignUpAsAttendeeRequest : ICommand<AttendeeDto>
    {
        public required string ConventionId { get; init; }
    }

    public class SignUpAsAttendeeRequesttHandler : IRequestHandler<SignUpAsAttendeeRequest, AttendeeDto>
    {
        ...
        public SignUpAsAttendeeRequesttHandler(
        ...
        public async Task<AttendeeDto> Handle(SignUpAsAttendeeRequest req, CancellationToken ct)
        {
