...
namespace Payments.Application.Authorization.Handlers
{
    // TODO: Replace placeholder
    public class ExampleAuthorizationHandler : OperationAuthorizationHandler<Payment> // instead of string use your Agregat
    {
