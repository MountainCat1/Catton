...
using Convention.Domain.Abstractions;
using Convention.Infrastructure.Errors.Database;
using Convention.Infrastructure.Extensions;
using MediatR;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Logging;

namespace Convention.Infrastructure.Generics;
