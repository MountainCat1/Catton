...
using TicketDomain.Domain.Abstractions;
using TicketDomain.Infrastructure.Errors.Database;
using TicketDomain.Infrastructure.Extensions;
using MediatR;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Logging;

namespace TicketDomain.Infrastructure.Generics;
