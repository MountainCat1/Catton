using TicketDomain.Api;
using TicketDomain.Api.Extensions;
using TicketDomain.Api.MediaRBehaviors;
using TicketDomain.Api.Middlewares;
using TicketDomain.Application;
using TicketDomain.Application.Configuration;
using TicketDomain.Application.Services;
using TicketDomain.Infrastructure.Contexts;
...
services.AddDbContext<TicketDomainDbContext>(options =>
{
    options.UseSqlServer(configuration.GetConnectionString("TicketDomainDatabase"),
...
if (!app.Environment.IsDevelopment())
    await app.MigrateDatabaseAsync<TicketDomainDbContext>();
