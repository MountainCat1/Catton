using TicketApi.Api;
using TicketApi.Api.Extensions;
using TicketApi.Api.MediaRBehaviors;
using TicketApi.Api.Middlewares;
using TicketApi.Application;
using TicketApi.Application.Configuration;
using TicketApi.Application.Services;
using TicketApi.Infrastructure.Contexts;
...
services.AddDbContext<TicketApiDbContext>(options =>
{
    options.UseSqlServer(configuration.GetConnectionString("TicketApiDatabase"),
...
if (!app.Environment.IsDevelopment())
    await app.MigrateDatabaseAsync<TicketApiDbContext>();
